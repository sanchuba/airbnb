...
function renderAttention(){
  ...
  const values={arrivingSoon:arriving,idToVerify:ids,invoiceToCreate:inv,missingBookingReference:missingBookingRef,expiredRegistrationLink:expiredLinks,needsAttention:flagged};
  ...
  const any=arriving+ids+inv+missingBookingRef+expiredLinks+flagged>0;
