...
function renderAttention(){
  ...
  const values={arrivingSoon:arriving,idToVerify:ids,invoiceToCreate:inv,missingBookingReference:missingBookingRef};
  ...
  const any=arriving+ids+inv+missingBookingRef>0;
